...
variable "pub_1_staging_subnet_cidr_block" {}
variable "pub_1_subnet_az_staging" {}

variable "pub_2_staging_subnet_cidr_block" {}
variable "pub_2_subnet_az_staging" {}

variable "pub_3_staging_subnet_cidr_block" {}
variable "pub_3_subnet_az_staging" {}
